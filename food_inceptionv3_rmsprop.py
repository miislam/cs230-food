...
print("First pass")
checkpointer = ModelCheckpoint(filepath='inceptionv3_rmsprop_first.3.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
...
checkpointer = ModelCheckpoint(filepath='inceptionv3_rmsprop_second.3.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
...
with open("model_inceptionv3_rmsprop.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_inceptionv3_rmsprop.h5")
