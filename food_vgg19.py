...
print("First pass")
checkpointer = ModelCheckpoint(filepath='vgg19_first.3.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
...
checkpointer = ModelCheckpoint(filepath='vgg19_second.3.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
